"""
Django settings for long_fire_42044 project.
...
ROOT_URLCONF = 'long_fire_42044.urls'
...
WSGI_APPLICATION = 'long_fire_42044.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_fire_42044 API",
    "DESCRIPTION": "API documentation for long_fire_42044 App",
    "VERSION": "v1",
}
